    ...
    <section className="visitor-info">
      <div className="visitor-info__container">
              ...
              {openIndex === index && (
                <div className="visitor-info__details-text">
                  {item.answers.map((answer, i) => (
                    ...
                    // <p  className="visitor-info_details-text">{answer}</p>
                  ))}
                </div>
              )}
            </div>
        ...
        {activeButton === "intensive-care-unit" && (
          <div className="visitor-info__rules-container">
            <p className="visitor-info__rules-text">
              Пребывание пациента в ОРИТ не является основанием для запрета его
              посещения родственниками или законными представителями
            </p>
            <p className="visitor-info__rules-text">
              Перед посещением пациента, находящегося в ОРИТ, просим
              родственников или законных представителей пациента ознакомиться с
              памяткой для посетителей «О правилах посещения пациентов,
            ...
            <p className="visitor-info__rules-text">
              Предоставление информации о состоянии здоровья пациента, а также
              посещение пациента в условиях ОРИТ возможно при письменном или
              устном (при невозможности получения письменного) согласии
              пациента. При бессознательном состоянии пациента посетители, не
              являющиеся прямыми родственниками пациента, допускаются в ОРИТ
              только в сопровождении близкого родственника — отца, матери, жены,
              мужа, взрослых детей
            </p>
            <p className="visitor-info__rules-text">
            ...
            <p className="visitor-info__rules-text">
              ...
              респираторных инфекций и иных заболеваний, к посещению пациентов
              не допускаются
            </p>
            <p className="visitor-info__rules-text">
              Временное ограничение на посещение может быть установлено лечащим
              врачом или заведующим ОРИТ в связи с проведением
              лечебно—­диагностических мероприятий в реанимационной палате, во
              время которых не предусмотрено присутствие посторонних лиц
            </p>
            <div className="visitor-info__rules-buttons-container">
              <button className="visitor-info__rules-button">
                Полный список правил посещения
