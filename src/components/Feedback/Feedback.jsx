...
function Feedback() {
  ...
  // Вычисляем, сколько карточек помещается в контейнер
  const slidesToShow = Math.floor((containerWidth + cardGap) / cardTotalWidth);
        ...
        <div className="feedback__carousel" ref={carouselRef}>
          <div
            ...
            style={{
              ...
              width: isMobile
                ? "auto"
                : `${feedbacks.length * cardTotalWidth}px`,
            }}
          >
